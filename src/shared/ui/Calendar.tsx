...
const calendarButtonBaseClass = `inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-small typo-caption1 max-lg:typo-m-subtitle2 transition-all disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none aria-invalid:border-destructive`
  ...
  return (
    <div>
      <DayPicker
        ...
        className={cn(
          'bg-white group/calendar [--cell-size:--spacing(8)] max-lg:[--cell-size:--spacing(12)] pt-medium px-medium pb-base rounded-base in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent',
        ...
        classNames={{
          ...
          month_caption: cn(
            'flex items-center justify-center h-(--cell-size) w-full px-(--cell-size) max-lg:typo-m-subtitle2 typo-body3 text-black',
          ...
          caption_label: cn(
            'select-none',
            captionLayout === 'label'
              ? 'typo-body3 max-lg:typo-m-subtitle2'
        ...
        components={{
          ...
          Chevron: ({ className, orientation, ...props }) => {
            if (orientation === 'left') {
              return (
                <ChevronLeftIcon className={cn('size-4 text-grey-600', className)} {...props} />
              )
            }

            if (orientation === 'right') {
              return (
                <ChevronRightIcon className={cn('size-4 text-grey-600', className)} {...props} />
              )
            }
