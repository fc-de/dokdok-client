...
export const PERSONAL_RETROSPECTIVE_ENDPOINTS = {
  ...
  VIEW: (meetingId: number) => `${API_PATHS.MEETINGS}/${meetingId}/retrospectives/personal`,
  ...
  UPDATE: (meetingId: number) => `${API_PATHS.MEETINGS}/${meetingId}/retrospectives/personal`,
  // 개인 회고 삭제 (DELETE /api/meetings/{meetingId}/retrospectives/personal)
  DELETE: (meetingId: number) => `${API_PATHS.MEETINGS}/${meetingId}/retrospectives/personal`,
} as const
