...
let mockSummaryData: RetrospectiveSummaryResponse = {
  meetingId: 1,
  isPublished: false,
  publishedAt: null,
  topics: [
 ...
 * 회고 요약 목데이터 반환 함수
 */
export const getMockSummary = (): RetrospectiveSummaryResponse => {
 ...
 * 회고 요약 수정 목데이터 처리
 */
export const mockUpdateSummary = (data: UpdateSummaryRequest): RetrospectiveSummaryResponse => {
  mockSummaryData = {
    ...mockSummaryData,
    topics: mockSummaryData.topics.map((topic) => {
 ...
 * 회고 요약 발행 목데이터 처리
 */
export const mockPublishSummary = (): RetrospectiveSummaryResponse => {
  mockSummaryData = {
    ...mockSummaryData,
    isPublished: true,
